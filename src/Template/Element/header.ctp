          ...
          <div class="topa">
            <ul class="topa__left">
              <? if ($staticdata[0]['phone']) { ?>
                <li><a href="tel:+91<?= $staticdata[0]['phone'] ?>"><i class="fa-regular fa-phone"></i><span>+91 <?= $staticdata[0]['phone']; ?></span></a></li>
              <? }
            ...
            <ul class="topa__right">
              ...
              if ($staticdata[0]['whatsapp_no']) { ?>
                <li><a href="https://api.whatsapp.com/send?phone=+91<?= $staticdata[0]['whatsapp_no'] ?>&amp;text=Greetings%20from%20Layered%20Vastu.%20Feel%20free%20to%20submit%20your%20question,%20and%20we%20will%20be%20in%20touch%20shortly." rel="nofollow"><i class="fa-brands fa-whatsapp"></i></a></li>
              <? }
          ...
          <ul class="navbar-nav justify-content-start">
            ...
            <? foreach ($vastucategory as $singlevastucategory) { ?>
              <li class="nav-item dropdown">
                <a class="nav-link" href="<?= SITE_PATH . $singlevastucategory['category_url'] ?>" id="offcND" role="button">

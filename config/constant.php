...
define('ROOT_PATH', 'http://' . $_SERVER['HTTP_HOST'] . '/layredvastu.com/');
define('_BASEURL_', 'http://' . $_SERVER['HTTP_HOST'] . '/layredvastu.com/');
define('SITE_PATH', 'http://' . $_SERVER['HTTP_HOST'] . '/layredvastu.com/');
define('CDN_PATH', 'http://' . $_SERVER['HTTP_HOST'] . '/layredvastu.com/');
